...
urlpatterns = [
    ...
    path('me/',views.editProfileSecurity, name='edit_profile'),
    path('profile/<str:username>/',views.perfilConsult, name='perfil'),
    path('edit/<str:username>/',views.editProfile, name='edit'),
